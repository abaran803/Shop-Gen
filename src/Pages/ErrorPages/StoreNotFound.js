    ...
    <div className='d-flex'>
      <div className={` ${classes.errorText} vh-100 d-flex justify-content-center`}>
        <div className='w-75 h-100 d-flex flex-column justify-content-center'>
          ...
          <button className={`${classes.submitButton} mx-0 my-1 px-3 py-2 bg bg-success rounded text-white`} onClick={() => gotoStore('626c474f80f71594e827487a')}>Demo Shop</button>
        </div>
      </div>
